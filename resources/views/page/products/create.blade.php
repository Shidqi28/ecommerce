                    ...
                    <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="p-1 rounded-xl">
                            <div class="mb-4">
                                <div class="mb-4">
                                <label for="brand_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Brand Id<span class="text-red-500">*</span></label>
                                <input type="text" id="brand_id" name="brand_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Masukan Nama Brand Id Disini ..."
                                    oninput="this.value = this.value.toUpperCase();" />
                            </div>
                                <label for="category_id"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Categories<span class="text-red-500">*</span></label>
                                <input type="text" id="category_id" name="category_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Masukan Nama Categories Disini ..."
                                    oninput="this.value = this.value.toUpperCase();" />
                            </div>
                            <div class="mb-4">
                                <label for="name"
                            ...
                            <div class="mb-4">
                                <label for="base_price"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Base Price<span class="text-red-500">*</span>
                                </label>
                            ...
                            <div class="mb-4">
                                <label for="is_active"
                                    ...
                                    Is Active<span class="text-red-500">*</span class="text-red-500">
                                </label>
                                <select id="is_active" name="is_active"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm  rounded-lg 
                                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                                    dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                    <option value="">Masukan Is Active Disini ...</option>
